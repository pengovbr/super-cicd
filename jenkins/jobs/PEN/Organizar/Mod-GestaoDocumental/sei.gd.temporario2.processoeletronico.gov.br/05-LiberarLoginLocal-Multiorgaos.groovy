...
pipeline {
    ...
    parameters {
		booleanParam(name: 'Instrucoes',
		      defaultValue: false,
		      description: 'Esse job vai permtir o login sem AD no multiorgao para o ambiente http://sei.gd.temporario2.processoeletronico.gov.br/ Usuario e senha mesma coisa')
