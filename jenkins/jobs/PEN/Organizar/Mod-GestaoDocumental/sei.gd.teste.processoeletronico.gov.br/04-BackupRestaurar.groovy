...
pipeline {
    ...
    parameters {
		booleanParam(name: 'Instrucoes',
		      defaultValue: false,
		      description: 'Esse job vai parar o http://sei.gd.teste.processoeletronico.gov.br/ e restaurar o backup desejado. Depois reinicia os conteineres. No job tem a opcao de vc listar os backups disponiveis')
        choice(
      	      name: 'choiceAviso',
