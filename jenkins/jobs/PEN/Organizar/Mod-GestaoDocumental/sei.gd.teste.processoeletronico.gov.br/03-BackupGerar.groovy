...
pipeline {
    ...
    parameters {
		booleanParam(name: 'Instrucoes',
		      defaultValue: false,
		      description: 'Esse job vai parar o http://sei.gd.teste.processoeletronico.gov.br/ e gerar um backup dos dados com o nome bkpseigd.sei4.0.9.20220101-1200. Depois reinicia os conteineres. Esse backup podera ser restaurado no job de restauracao.')
				...
				script {
				    timeout(time: 3, unit: 'MINUTES') {
				        ...
				        do
				           ...
				           curl -sL --head --resolve "sei.gd.teste.processoeletronico.gov.br:80:192.168.0.2" --request GET sei.gd.teste.processoeletronico.gov.br/sei/ | grep "200 OK"
				           resultado=\$?;
				        done
