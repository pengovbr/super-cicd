            ...
            steps {
                ...
                dir('kube'){
                    ...
                    if [ "${MANTER_DADOS}" = "sim" ]; then
                        ...
                        if [ -n "\${POD_APP}" ]; then
                            kubectl -n ${JOB_NS} exec "\${POD_APP}" -- sh -c 'rm -rf /opt/sei/web/modulos/*protocolo-integrado*; rm -f /sei/controlador-instalacoes/instalado-modulo-pi.ok;rm -f /opt/sei/config/mod-protocolo-integrado/ConfiguracaoModProtocoloIntegrado.php' || true
                        fi
                    else
