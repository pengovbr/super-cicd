...
pipeline {
    ...
    parameters {
		booleanParam(name: 'Instrucoes',
		      defaultValue: false,
		      description: 'Esse job vai parar o http://sei.gd.temporario2.processoeletronico.gov.br/ e gerar um backup dos dados com o nome bkpseigd.sei4.0.9.20220101-1200. Depois reinicia os conteineres. Esse backup podera ser restaurado no job de restauracao.')
