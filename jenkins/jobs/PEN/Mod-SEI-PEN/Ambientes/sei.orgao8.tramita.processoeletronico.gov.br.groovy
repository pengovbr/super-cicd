        ...
        stage('Inicializar Job'){
            steps {
                ...
                script{
                    ...
                    JOB_URL = "sei.orgao8.tramita.processoeletronico.gov.br"
                    JOB_ORGAO = "ORGAO8"
                    JOB_NS = "mod-sei-pen-orgao8"

                    JOB_MODULOPI_URL = "https://protocolointegrado.preprod.nuvem.gov.br/ProtocoloWS/integradorService?wsdl"
                    JOB_MODULOPI_USUARIO = "credModuloPIOrgao8Usuario"
                    JOB_MODULOPI_SENHA = "credModuloPIOrgao8Senha"
                    ...
                    JOB_MODULOLOGINUNICO_REDIRECTURL = "https://sei.orgao8.tramita.processoeletronico.gov.br/sei/modulos/loginunico/controlador_loginunico.php"
                    JOB_MODULOLOGINUNICO_URLLOGOUT = "https://sei.orgao8.tramita.processoeletronico.gov.br/sei/modulos/loginunico/logout.php"
