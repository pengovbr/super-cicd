        ...
        stage('Inicializar Job'){
            steps {
                ...
                script{
                    ...
                    JOB_URL = "sei.pr.teste.processoeletronico.gov.br"
                    JOB_ORGAO = "PR"
                    JOB_NS = "sei-atos-sancao-veto"
                    ...
                    MODULOSANCAOVETO_INSTALAR = params.moduloSancaoVetoInstalar
                    MODULOSANCAOVETO_VERSAO = params.moduloSancaoVetoVersao

                    MODULOATOS_INSTALAR = params.moduloAtosInstalar
                    MODULOATOS_VERSAO = params.moduloAtosVersao
