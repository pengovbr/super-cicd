...
pipeline {
    ...
    parameters {
		booleanParam(name: 'Instrucoes',
		      defaultValue: false,
		      description: 'Esse job vai parar o http://sei.gd.temporario1.processoeletronico.gov.br/ e restaurar o backup desejado. Depois reinicia os conteineres. No job tem a opcao de vc listar os backups disponiveis')
        choice(
      	      name: 'choiceAviso',
		...
		stage('Listar os backups'){
			...
			steps {
				...
				script{
                    ...
                    env.EXECUTARRESTORE = params.choiceAviso
                    env.BKPARESTAURAR= params.nomeBackup
				...
				script {
				    timeout(time: 3, unit: 'MINUTES') {
				        ...
				        do
				           ...
				           curl -sL --head --resolve "sei.gd.temporario1.processoeletronico.gov.br:80:127.0.0.1" --request GET sei.gd.temporario1.processoeletronico.gov.br/sei/ | grep "200 OK"
				           resultado=\$?;
				        done
